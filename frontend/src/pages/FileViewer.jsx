    ...
    <>
      {
        authenticated ? (
          <div className='flex items-center justify-center h-screen'>
            {/* file viewer */}
            <div className="h-[450px] shadow-2xl border border-black rounded-lg table-auto p-3 w-2/5 overflow-y-auto">
          ...
          <div className='flex items-center justify-center h-screen'>
            {/* request password */}
            <form className='border border-black px-5 py-5 w-1/3 rounded-md' onSubmit={accessFiles}>
              <input
                type='password'
                name='password'
